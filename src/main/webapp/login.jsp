    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#captchaImage").click(function () {//点击更换验证码
                $("#captchaImage").prop("src", "${pageContext.request.contextPath}/admin/image?time=" + new Date());
            });
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/admin/image"
                         title="点击更换验证码"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <th>&nbsp;</th>
                <td>
                    <input type="button" class="homeButton" value="" onclick="javascript:void(0)"><input id="login"
                                                                                                         type="button"
                                                                                                         class="loginButton"
                                                                                                         value="登录">
                </td>
